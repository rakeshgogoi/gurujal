...
/**
 * Blog hero — "Stories from the Field".
 *
 * Matches the Events / Reports hero pattern: full-height dark band,
 * backdrop shown in natural colour with the blue overlay anchored to
 * the text column on desktop, left-aligned headline + lead in a
 * 12-col grid.
 */
        ...
        <div className="grid w-full items-center gap-8 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7">
            ...
            <h1 className="text-3xl font-extrabold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl">
              Stories{" "}
              <em className="not-italic text-brand-teal-bright">from</em>{" "}
              the <em className="not-italic text-brand-green">field</em>
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/85 sm:mt-6 sm:text-lg lg:text-xl">
              Notes on restoration, community and water security — written
              by the GuruJal team and published on Substack.
            </p>
          </div>
        </div>
      </div>

...
/**
 * Solution-page closing CTA. Same gradient block as the event-detail
 * pages, just tailored for solution-level next steps (partner / get in
 * touch / support).
 */

export function SolutionClosingCta({
  eyebrow,
  heading,
  body,
  primaryCta,

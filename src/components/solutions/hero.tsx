  ...
  return (
    <section className="relative isolate flex flex-col overflow-hidden bg-brand-deep min-h-[calc(100vh-190px)]">
      {/* Backdrop — aerial of a restored square pond surrounded by farm
          plots, dirt paths and community land. The overlay is anchored
          to the text column on desktop so the photo on the right reads
        ...
        <div className="grid w-full items-center gap-8 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/85 sm:mt-6 sm:text-lg lg:text-xl">
              Quick, isolated and short-term fixes in water resource
              management may provide temporary relief, but they fail to
              address the root causes of the crisis. GuruJal&apos;s
              philosophy is integrated and context-specific — complementary
              services and technology-driven governance, working in concert.
            </p>
          </div>
        </div>
      </div>

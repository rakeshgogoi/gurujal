...
/**
 * Volunteer hero — "Volunteer with GuruJal · Skill. Act. Lead. Restore."
 *
 * Mirrors the Careers-page hero pattern (same backdrop image, same
 * dark-band + left-aligned copy layout) since both pages sit under the
 * new "Work With Us" nav parent.
 */
export function VolunteerHero() {
  return (
    <section className="relative isolate flex flex-col overflow-hidden bg-brand-deep min-h-[calc(100vh-190px)]">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -left-40 -top-32 h-96 w-96 rounded-full bg-brand-green/20 blur-3xl"
      />
      <div
        aria-hidden
        ...
        <div className="grid w-full items-center gap-8 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7">
            <p className="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-brand-teal-bright sm:mb-4 sm:text-sm">
              A College Volunteering Programme
            </p>
